...
export default class CoeditorView {
  ...
  constructor(serializedState) {
    ...
    this.serverEditor.element.onblur = this.getOnBlurFn(this.sessionIdEditor.element);
    this.sessionIdEditor.element.onblur = this.getOnBlurFn(this.clientIdEditor.element);
    this.clientIdEditor.element.onblur = this.getOnBlurFn(this.serverEditor.element);
  }

  getOnBlurFn(nextElement) {
    return function() {
      nextElement.focus();
    };
  }
