...
export default {
  ...
  syncTab() {
    this.router.syncTabOn = !this.router.syncTabOn;
  },
  ...
  onSocketOpened() {
    ...
    this.subscriptions.add(atom.workspace.observeTextEditors( (editor) => {
      ...
      paths[1] = this.normalizePath(paths[1]);
  ...
  isProjectFile(absolutePath) {
    ...
    if (this.projectPath === paths[0]) {
      ...
      result.relativePath = this.normalizePath(paths[1]);
      return result;
    }
    return result;
  },
