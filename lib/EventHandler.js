...
export default class EventHandler {
  ...
  onCursorMoved(positionObj, clientId) {
    ...
    // if (typeof this.cursorMarker !== 'undefined') {
    //   this.cursorMarker.destroy();
    // }

    // this.cursorMarker = this.editor.markBufferPosition(Point.fromObject(positionObj), {
    //   'invalidate': 'never'
    // });
    ...
    // this.editor.decorateMarker(this.cursorMarker, {
    //   type: 'overlay',
    //   position: 'head',
    //   item: cursor
    // });
